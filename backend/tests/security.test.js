...
const promptShield_1 = require("../src/middleware/promptShield");
describe('Security Input Sanitizer', () => {
    it('should strip HTML tags successfully', () => {
        ...
        const clean = (0, promptShield_1.sanitizeString)(dirty);
    ...
    it('should escape simple quotes and semi-colons for SQL safety', () => {
        ...
        const clean = (0, promptShield_1.sanitizeString)(malicious);
        expect(clean).toContain("\\'");
        expect(clean).toContain('\\;');
    });
    it('should trim whitespace correctly', () => {
        const padded = '   clean me    ';
        expect((0, promptShield_1.sanitizeString)(padded)).toBe('clean me');
    });
});
